...
import logoBanner from '../../images/login.png';
...
const Login = () => {
  ...
  return (
    <div className="container login-container">
      <div className="row">
        <div style={{height:'500px'}} className=" loginForm offset-md-1 shadow rounded mb-5 col-md-4 mt-5">
          ...
          >
            ...
            <input
              className="btn mb-3  btn-color book-btn text-bold button form-group form-control p-2"
              type="submit"
            ...
            {newUser && (
              <button
                ...
                className="btn btn-color book-btn py-1  button form-group form-control"
              >
      ...
      width:'100%'}} className="img-fulid" src={logoBanner} alt="logoBanner"/>
      </div>
      </div>
